...
export function AddressAutocomplete({
  ...
  return (
    <div className="relative">
      ...
      {open && (
        <ul className="absolute z-30 mt-1 max-h-56 w-full overflow-auto rounded-md border border-slate-300 bg-white text-sm shadow-lg dark:border-slate-700 dark:bg-slate-800">
          {suggestions.map((s, i) => (
            <li key={i}>
              <button
                type="button"
                ...
                className="block w-full px-3 py-2 text-left text-slate-900 hover:bg-slate-100 dark:text-slate-100 dark:hover:bg-slate-700"
              >
