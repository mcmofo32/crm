    ...
    <div className="flex flex-col gap-6">
      ...
      <div className="grid grid-cols-1 gap-6 lg:grid-cols-[260px_1fr]">
        <div className="flex flex-col gap-2 rounded-lg border border-slate-200 bg-white p-3 dark:border-slate-800 dark:bg-slate-900">
          ...
          {tabs.length === 0 ? (
            <p className="px-1 py-2 text-sm text-slate-400 dark:text-slate-500">Nog geen mappen.</p>
          ) : (
            <div className="flex flex-col gap-3">
              {tabs.map((tab) => (
                <div key={tab.id}>
                  ...
                  <div className="ml-1 mt-1 flex flex-col gap-0.5 border-l border-slate-100 pl-3 dark:border-slate-800">
        ...
        <div className="flex flex-col gap-4">
          ...
          {documents.length === 0 ? (
            <p className="text-base text-slate-500 dark:text-slate-400">Nog geen documenten toegevoegd.</p>
          ) : (
            <div className="overflow-hidden rounded-lg border border-slate-200 bg-white dark:border-slate-800 dark:bg-slate-900">
              <table className="w-full text-left text-sm">
                <thead className="border-b border-slate-100 bg-slate-50 text-xs uppercase tracking-wide text-slate-400 dark:border-slate-800 dark:bg-slate-800/60 dark:text-slate-500">
                  <tr>
